...
const PostContest = () => {
  const [data, setData] = useState([]); // Store merged past contests
  ...
  useEffect(() => {
    ...
    async function fetchData() {
      ...
      // Merge and filter past contests
      ...
      const mergedData = [...adminData, ...clanData]
        ...
        .filter((contest) => new Date(contest.date) < currentDate); // Keep only past contests
